 ...
 * Create a rule.
 */
const createRule = (data) => ESLintUtils.RuleCreator((name) => `https://github.com/infctr/eslint-plugin-typescript-sort-keys/blob/master/docs/rules/${name}.md`)(data);

const getObjectBody$3 = (node) => node.type === AST_NODE_TYPES.TSInterfaceDeclaration && node.body.body;
/**
...
const getObjectBody$2 = (node) => node.type === AST_NODE_TYPES.TSTypeLiteral && node.members;
/**
 * The name of this rule.
 */
const name$2 = "type";
...
const getObjectBody$1 = (node) => AST_NODE_TYPES.TSEnumDeclaration && node.members;
/**
 * The name of this rule.
 */
const name$1 = "type";
...
const getObjectBody = (node) => node.type === AST_NODE_TYPES.ArrowFunctionExpression && node.params;
/**
 * The name of this rule.
 */
const name = "type";
