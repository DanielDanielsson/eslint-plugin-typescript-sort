...
const invalid = [
   ...
   */
  {
    ...
    errors: [
      "Expected interface keys to be in ascending order. 'a' should be before 'b'.",
    ],
    optionsSet: [
      [],
      [SortingOrder.Ascending],
  ...
  {
    code: noFormat`interface U {a:T; c: { y: string; x: string; }; b:T;}`,
    output: noFormat`interface U {a:T; b:T; c: { y: string; x: string; };}`,
    errors: [
      "Expected interface keys to be in ascending order. 'b' should be before 'c'.",
      //   "Expected interface keys to be in ascending order. 'c' should be before 'd'.",
